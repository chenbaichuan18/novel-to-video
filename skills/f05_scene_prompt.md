...
> ⚠️ **【固定拼接】「画面构图」（开头）和「质量要求+避免出现」（结尾）均由代码自动拼接。你不需要输出这三段，直接从「时代与地域背景」开始，到「场景设计约束」结束即可。**
...
质量要求（固定后缀——你不需输出，代码会自动拼接）：超写实(photorealistic)、高细节、建筑材质真实、电影感。
避免出现（固定后缀——你不需输出，代码会自动拼接）：人物，人，男人，女人，儿童，人形轮廓，人影，文字，标签，标题，说明，水印，签名，三视图，多视角拼贴，分镜头布局，多面板展示，卡通，动漫，绘画，插画，3D渲染，模糊，低质量，畸变，扭曲透视，改变场景核心元素。
...
- **visual_style 的「画面构图」「质量要求」「避免出现」三段均由代码自动拼接**——你输出时从「时代与地域背景」开始，到「场景设计约束」结束即可
